...
-- ============================================================
alter function public.set_updated_at() set schema agamotto;
alter function public.manage_tracked_pr_on_reviewed() set schema agamotto;

-- ============================================================
-- 3. Move tables (reviews before tracked_prs — FK dependency)
-- ============================================================
alter table public.memories set schema agamotto;
alter table public.review_history set schema agamotto;
alter table public.review_checkpoints set schema agamotto;
alter table public.reviews set schema agamotto;
alter table public.tracked_prs set schema agamotto;
alter table public.configured_repos set schema agamotto;
alter table public.settings set schema agamotto;
